...
header  = f'<h1 style="text-align: center; color: white;">Предсказание оценки на тесте:</h1>'

prediction_text = f'<h1 style="text-align: center; color: white;">{round(prediction[0])}</h1>'
